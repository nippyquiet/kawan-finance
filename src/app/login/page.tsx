...
import { LogIn, Wallet, TrendingUp, PiggyBank, Shield } from "lucide-react";
    ...
    <div className="min-h-screen bg-gradient-to-b from-blue-50 to-white flex flex-col">
      ...
      <div className="flex-1 flex flex-col items-center justify-center px-6 text-center">
        ...
        >
          <button
            type="submit"
            className="w-full flex items-center justify-center gap-3 bg-white border border-zinc-200 hover:border-zinc-300 text-zinc-800 px-6 py-3.5 rounded-2xl font-medium shadow-sm hover:shadow transition-all"
          >
        ...
        <p className="text-xs text-zinc-400 mt-6">
          Data kamu hanya bisa diakses olehmu · Enkripsi end-to-end
        </p>
      </div>
